...
def testForImprovements2(solution):
    """
    Using if and else statements, swaps a timing for a phase of the appliance's schedule with a time directly before or directly after that 
    makes the solution cheaper.
    """
...
best_solution = findBestSolutions(solutions_from_solution1)
print(best_solution)


graph_2_different_solutions(solution1, best_solution)
